...
//    }
//    func setData() {
//        if weeklyMoodLog.isEmpty {
//            moodChartView.data = nil
//            moodChartView.setNeedsDisplay()
//            return
//        }
//
//        let sortedLogs = weeklyMoodLog.sorted { ($0.date ?? Date()) < ($1.date ?? Date()) }
//
...
class MoodChartCollectionViewCell: UICollectionViewCell, ChartViewDelegate {
    ...
    var isWeekly: Bool = true   // true = weekdays, false = day numbers
    ...
    func setData() {
        ...
        moodChartView.xAxis.valueFormatter = WeekFormatter(labels: dayLabels)
        moodChartView.xAxis.axisMinimum = 0
